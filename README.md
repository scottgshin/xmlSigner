...
3. A configuration file named "[signXmlFile.ini](https://github.com/donho/xmlSigner/blob/master/xmlSigner/signXmlFile.ini)". Place it next to "xmlSigner.exe" and adjust the parameters according your needs.
